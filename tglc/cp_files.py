...
# Read the CSV file
csv_file = '/home/tehan/data/cosmos/Jeroen/keplerq9v3/Jeroen_keplerq9v3_even_files.csv'  # replace with your CSV file path
...
# Destination folder
destination_folder = '/home/tehan/data/cosmos/Jeroen/keplerq9v3/lc/'  # replace with your destination folder path
