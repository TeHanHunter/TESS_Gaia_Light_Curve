...
# Read the CSV file
csv_file = '/home/tehan/data/cosmos/Jeroen/fourlists/Jeroen_all_even_files.csv'  # replace with your CSV file path
...
# Destination folder
destination_folder = '/home/tehan/data/cosmos/Jeroen/fourlists/lc/'  # replace with your destination folder path
